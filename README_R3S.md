...
**Правило выбора: сначала страна, потом скорость.** Реклама определяется
адресом выхода, а не качеством канала, поэтому российский узел выигрывает у
любого зарубежного. Если российских живых нет, скрипт берёт быстрейший и
явно предупреждает, что реклама будет.
...
*Мёртвые узлы отсеиваются по стране.* Если `ipinfo.io` не ответил, скорость
не меряется — экономит по сорок секунд на каждом.
