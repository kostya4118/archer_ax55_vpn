...
Один домен не может обслуживаться двумя секциями: если сервис вынесен в
отдельную секцию, его нужно убрать из списков основной.
...
## Часть 5. Расширение раздела на всю карту
